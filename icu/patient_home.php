		...
		<div class="container"><img src="assets/img/logo.jpg" style="width:128px;height:60px;" />
			<div class="collapse navbar-collapse" id="navcol-1">
				<ul class="nav navbar-nav ml-auto">
					...
					<li role="presentation" class="nav-item" style="align-content: center; margin-top: .5rem"><a href="suggestion_noti.php"><ion-icon src="assets/img/noti.svg"></ion-icon></a></li>
				</ul>
			</div>
		</div>
	</nav>
